  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="pt-16">
        ...
        {/* Application Form (sin planes ni precios) */}
            ...
            <Card className="bg-card/90 border border-border">
              <CardHeader>
                <CardTitle className="text-foreground text-2xl">
                  {t('join.membershipApplication')}
                </CardTitle>
                <CardDescription className="text-muted-foreground">
                  {/* Mensaje acorde al dossier: salud, inclusión, coordinación con centros */}
        ...
        {/* Benefits (enfoque salud, comunidad, desplazamiento a centros) */}
