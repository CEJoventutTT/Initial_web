              ...
              <div className="lg:col-span-3">
                <div 
                  className="prose prose-invert max-w-none
                             prose-headings:font-black prose-h2:text-white prose-h3:text-white
                             prose-p:text-white/90 prose-li:text-white/90 prose-strong:text-white
                             prose-a:text-brand-teal hover:prose-a:text-brand-teal/80
                ...
                <div className="mt-12 p-6 bg-white/5 rounded-lg border border-white/10">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-white/85">{article.authorBio}</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="sticky top-24 space-y-8">
                  ...
                  <div className="bg-white/5 p-6 rounded-lg border border-white/10">
                    ...
                    <div className="space-y-2">
                      <Button variant="outline" size="sm" className="w-full border-white/20 text-white/85 hover:bg-white/10">
                        Share on Twitter
                      </Button>
                      <Button variant="outline" size="sm" className="w-full border-white/20 text-white/85 hover:bg-white/10">
                        Share on Facebook
                  ...
                  <div className="bg-white/5 p-6 rounded-lg border border-white/10">
                    ...
                    <div className="space-y-4">
                      <Link href="/news/youth-development-program" className="block group">
                        <div className="text-brand-teal group-hover:text-brand-teal/80 font-medium text-sm mb-1">
                          Youth Development Program Launches
                        </div>
                        <div className="text-white/60 text-xs">Jan 25, 2024</div>
                      </Link>
                      <Link href="/news/member-spotlight-sarah" className="block group">
                        <div className="text-brand-teal group-hover:text-brand-teal/80 font-medium text-sm mb-1">
                          Member Spotlight: Sarah Chen
                        </div>
                        <div className="text-white/60 text-xs">Jan 22, 2024</div>
                      </Link>
                    </div>
                  </div>
                </div>
