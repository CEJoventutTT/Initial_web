...
export default function AboutPage() {
  ...
  const values = [
    {
      title: t('about.values.inclusionTitle'),
      description: t('about.values.inclusionDesc'),
      icon: Heart
    },
    {
      title: t('about.values.integrationTitle'),
      description: t('about.values.integrationDesc'),
      icon: Users
    },
    {
      title: t('about.values.developmentTitle'),
      description: t('about.values.developmentDesc'),
      icon: Target
    }
  ]
