...
export const SEO_TEXT: Record<PageKey, Record<Lang, { title: string; description: string }>> = {
  ...
  trainings: {
    ...
    en: {
      ...
      description: 'Table tennis attendance_sessions for every level. Activities for youth, adults and seniors.',
    },
    ca: {
      title: 'Entrenaments i activitats | Club Esportiu Joventut TT',
      description: 'attendance_sessions per a tots els nivells. Activitats per a joves, adults i gent gran.',
    },
  },
  competition: {
